...
| Commercial Configuration has no deactivate/reactivate capability at all | Batch 11 D-003, D-004, D-015, D-021 | D-003, D-004, D-015, D-021 (document the absence; no product decision made) | PRODUCT DECISION REQUIRED | Record the open question: should Commercial Configuration gain a governed deactivate/reactivate path independent of the parent Customer's `is_active`, and if so what should it mean for open components and in-flight versions? Do not invent the answer. | Unlike I-003/I-004 (now decided manual-only) or the other five PD-00N items (all closed), this specific gap was never given a PD number and was never decided one way or the other across 16 batches. It remains genuinely open. |
